    ...
    <>
      ...
      <Row className="">
        <p style={{ fontWeight: "bold", fontSize: "1.1rem" }}>
          Booking Code: <span style={{ color: "#7126b5" }}>{BookingCode}</span>
        </p>
      </Row>
      ...
      <Row>
        ...
        <Col xs={6} className="d-flex justify-content-end">
          <p style={{ fontWeight: "600", color: "#8e6fdd" }} className="m-0">
            Keberangkatan
          </p>
        </Col>
      </Row>
      ...
      <Row>
        <Col md={{}}>
          <p style={{ fontWeight: "bold" }} className="my-0 mx-1 ps-5">
          ...
          {BookingStatus ? (
            ...
            <>
              ...
              <p className="my-0 mx-1 ps-5">Cabin baggage {cabinBaggage} kg</p>
      ...
      <Row className="mb-3">
        <Col>
          <p className="m-0">
            {
              (arrivalDate = new Date(arrivalDate).toLocaleDateString("id-ID", {
                day: "numeric",
                month: "long",
                year: "numeric",
              }))
