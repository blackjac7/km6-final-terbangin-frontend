...
const FormArea = ({ title, isFullScreen, isMobile, onClick }) => {
  ...
  const getClassStyle = (buttonId) => {
    return {
      cursor: "pointer",
      backgroundColor: selectedSeatClass === buttonId ? "#7126b5" : "initial",
            ...
            <Row className="mb-4 ">
              ...
              <Col md={5} sm={12}>
                <Row className="d-flex">
                  <Col md={{ span: 3, offset: 1 }} xs={3} className="d-flex">
                    <Image src={plane} style={{ width: 25 }} />
              ...
              <Col md={5} className={isMobile ? "pt-3" : ""}>
                <Row>
                  ...
                  <Col md={3} xs={3} className="d-flex align-items-center">
                    <Image src={seat} /> <span className="ms-1">To</span>
                  </Col>
                  {/* Passanger Info */}
                  <Col md={4} xs={4}>
                      ...
                      >
                        ...
                        >
                          ...
                          <Col className="d-flex justify-content-end">
                            <img src={getClassImages("Economy")} alt="" />
                          </Col>
                        </Row>
                        {/* Business */}
                        <Row
                        ...
                        >
                          ...
                          <Col className="d-flex justify-content-end">
                            <img src={getClassImages("Bussines")} alt="" />
                          </Col>
                        </Row>
                        {/* First Class */}
                        <Row
                        ...
                        >
                          ...
                          <Col className="d-flex justify-content-end">
                            <img src={getClassImages("FirstClass")} alt="" />
                          </Col>
                        </Row>
                      </Modal.Body>
                      <Modal.Footer style={{ border: "none" }}>
